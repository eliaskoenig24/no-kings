...
const NX: Record<string, Record<string, string>> = {
  ...
  sim_on:       { de: 'Simulation ansehen', en: 'View simulation' },
  sim_off:      { de: '← Zurück zu echten Daten', en: '← Back to real data' },
  sim_why:      { de: 'Die Simulation zeigt, wie diese Seite mit tausenden Zwillingen aussehen wird. Nichts davon fließt in echte Auswertungen ein.', en: 'The simulation shows what this page will look like with thousands of twins. None of it feeds into real results.' },
  founding_title: { de: 'Gründungsphase', en: 'Founding phase' },
  founding_body: { de: 'Das Netzwerk ist live — und jung. Auswertungen des kollektiven Willens zeigen wir erst ab', en: 'The network is live — and young. We only show aggregates of the collective will once there are' },
  founding_body2: { de: 'Personen. Darunter wäre ein Durchschnitt statistisches Rauschen und könnte einzelne Profile verraten. Ehrliche Zahlen von Anfang an: Das ist der Punkt dieser Plattform.', en: 'persons. Below that, an average is statistical noise and could expose individual profiles. Honest numbers from day one — that is the point of this platform.' },
  founding_progress: { de: 'Personen bis zur ersten Auswertung', en: 'persons until the first aggregate' },
  founding_cta: { de: 'Du kannst eine der ersten sein: Trainiere deinen Zwilling und teile ihn ins Netzwerk.', en: 'You can be one of the first: train your twin and share it to the network.' },
  persons:      { de: 'Personen', en: 'persons' },
  verified:     { de: 'mit Proof-of-Work', en: 'with proof-of-work' },
  dedup_note:   { de: 'dedupliziert aus', en: 'deduplicated from' },
  events_word:  { de: 'Events — jede Person zählt genau einmal', en: 'events — every person counts exactly once' },
};
