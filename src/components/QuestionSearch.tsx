...
const TX = {
  ph: { de: 'Frag die Welt — Thema eintippen…', en: 'Ask the world — type a topic…', es: 'Pregunta al mundo — escribe un tema…', fr: 'Demande au monde — tape un sujet…', pt: 'Pergunte ao mundo — digite um tema…', ar: 'اسأل العالم — اكتب موضوعًا…', zh: '问问世界——输入一个话题…', ja: '世界に聞く — トピックを入力…', hi: 'दुनिया से पूछो — विषय लिखें…', ru: 'Спроси мир — введи тему…', id: 'Tanya dunia — ketik topik…', tr: 'Dünyaya sor — bir konu yaz…', ko: '세상에 물어보세요 — 주제 입력…', it: 'Chiedi al mondo — scrivi un tema…', nl: 'Vraag het de wereld — typ een onderwerp…', pl: 'Zapytaj świat — wpisz temat…', uk: 'Запитай світ — введи тему…', vi: 'Hỏi thế giới — nhập chủ đề…', bn: 'বিশ্বকে জিজ্ঞেস করো — বিষয় লেখো…', fa: 'از جهان بپرس — موضوعی بنویس…' },
